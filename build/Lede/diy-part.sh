...
sed -i '/<tr><td width="33%"><%:CPU usage/a <tr><td width="33%"><%:Compiler author%></td><td><a target="_blank" href="https://xsui.net">阳光宅男</a></td></tr>' package/lean/autocore/files/x86/index.htm
...
export Op_name="XSUI"               # 修改主机名称为OpenWrt-123(填0为不作修改)
...
export Customized_Information="阳光宅男"  # 个性签名,你想写啥就写啥，(填0为不作修改)
